globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file://C:/Users/10190_kondou/git/gnt0608/msal-sso-sample/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file://C:/Users/10190_kondou/git/gnt0608/msal-sso-sample/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, createError } from 'file://C:/Users/10190_kondou/git/gnt0608/msal-sso-sample/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file://C:/Users/10190_kondou/git/gnt0608/msal-sso-sample/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file://C:/Users/10190_kondou/git/gnt0608/msal-sso-sample/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://C:/Users/10190_kondou/git/gnt0608/msal-sso-sample/node_modules/ofetch/dist/node.mjs';
import destr from 'file://C:/Users/10190_kondou/git/gnt0608/msal-sso-sample/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file://C:/Users/10190_kondou/git/gnt0608/msal-sso-sample/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://C:/Users/10190_kondou/git/gnt0608/msal-sso-sample/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file://C:/Users/10190_kondou/git/gnt0608/msal-sso-sample/node_modules/scule/dist/index.mjs';
import { klona } from 'file://C:/Users/10190_kondou/git/gnt0608/msal-sso-sample/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://C:/Users/10190_kondou/git/gnt0608/msal-sso-sample/node_modules/defu/dist/defu.mjs';
import { hash } from 'file://C:/Users/10190_kondou/git/gnt0608/msal-sso-sample/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file://C:/Users/10190_kondou/git/gnt0608/msal-sso-sample/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/Users/10190_kondou/git/gnt0608/msal-sso-sample/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/10190_kondou/git/gnt0608/msal-sso-sample/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/10190_kondou/git/gnt0608/msal-sso-sample/node_modules/radix3/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"C:/Users/10190_kondou/git/gnt0608/msal-sso-sample/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\10190_kondou\\git\\gnt0608\\msal-sso-sample","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\10190_kondou\\git\\gnt0608\\msal-sso-sample\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\10190_kondou\\git\\gnt0608\\msal-sso-sample\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\10190_kondou\\git\\gnt0608\\msal-sso-sample\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\Users\\10190_kondou\\git\\gnt0608\\msal-sso-sample\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lazy_lMKHwe = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_lMKHwe, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_lMKHwe, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://C:/Users/10190_kondou/git/gnt0608/msal-sso-sample/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _virtual__headStatic = {"headTags":"<meta charset=\"utf-8\">\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">\n<title>MSAL-Sample</title>","bodyTags":"","bodyTagsOpen":"","htmlAttrs":"","bodyAttrs":""};
